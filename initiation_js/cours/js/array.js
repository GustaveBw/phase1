...
films.push("Indiana Jones et le temple maudit");
films.push("Robocop");
console.log("films");
...
document.querySelector("#btActualiser").addEventListener("click", function () {
  ...
  for (let i = 0; i < films.length; i++) {
    // je cree un element html <tr>
    const ligne = document.createElement("tr");
      // je cree un element <td> que j'ajoute a l'element <tr>
   ...
   cellule2.innerHTML = films[i][2]; //realisateur du film
   ligne.appendChild(cellule3);

    // J'ajoute la ligne <tr> a <tbody>
